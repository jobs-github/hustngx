...
ngx_int_t __post_request(ngx_http_request_t *r, void *data, ngx_int_t rc)
{
...
static void __active_ev(ngx_event_t * ev)
{
    ...
    ngx_http_fetch_header_t headers[] = {
        ...
        { ngx_string("User-Agent"), ngx_string("python-requests/2.7.0 CPython/2.7.8 Linux/2.6.32-504.el6.x86_64") }
    };
...
void ngx_http_fetch_init_test(ngx_pool_t * pool, ngx_log_t * log)
{
